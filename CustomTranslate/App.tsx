...
import { History, Keyboard, Camera, Sparkles, RotateCcw, Home } from 'lucide-react';
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex flex-col justify-center">
            ...
            <div className="ml-8 flex items-center gap-1 text-[11px] text-slate-400 font-medium -mt-0.5">
              <span>Created by.</span>
              <a 
                href="https://hanaspreadsheet.co.kr/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center gap-0.5 text-slate-600 hover:text-indigo-600 transition-colors"
              >
                Ergane <Home size={10} />
              </a>
            </div>
